...
def makeBoard():
    ...
    boardMaker.hideturtle()
    credits.goto(500,300)
    credits.pendown()
    credits.showturtle()
    credits.write("credits",align="center",font=("Verdana",25,"bold"))


    directions.goto(500, 100)
    directions.pendown()
    directions.showturtle()
    directions.write("directions",align="center",font=("Verdana",25,"bold"))
